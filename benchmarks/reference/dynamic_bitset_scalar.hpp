#ifndef FRANKLIN_CONTAINER_DYNAMIC_BITSET_OPTIMIZED_HPP
#define FRANKLIN_CONTAINER_DYNAMIC_BITSET_OPTIMIZED_HPP
...
#endif // FRANKLIN_CONTAINER_DYNAMIC_BITSET_OPTIMIZED_HPP
